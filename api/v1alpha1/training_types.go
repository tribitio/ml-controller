...
// Training is the Schema for the trainings API
type Training struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   TrainingSpec   `json:"spec,omitempty"`
	Status TrainingStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// TrainingList contains a list of Training
...
func init() {
	SchemeBuilder.Register(&Training{}, &TrainingList{})
}
